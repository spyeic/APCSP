...
def draw_axes(turtle_object, x_offset, y_offset):
    ...
    turtle_object.pendown()
    turtle_object.write(
        "25")  # this is half the pixel offset (50) because the graph is plotted with y values * 2 for a larger scale graph
    turtle_object.penup()
...
def graph_grip():
    ...
    messenger.pendown()
    messenger.write("Here is a visual representation of your grip strength captured in the game.",
                    font=('Arial', 12, 'bold'))
    ...
    messenger.pendown()
    messenger.write("On average, your grip strength is:" + str(round(average_grip, 4)) + " N",
                    font=('Arial', 12, 'bold'))
...
def start_game():
    ...
    # display message
    label = font.render("Game over! Click anywhere to continue...", 1,
                        (255, 255, 255))  # Make a surface out of the base font
