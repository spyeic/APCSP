...
class MultiFactorAuth(tk.Tk):
    ...
    def authenticate(self):
        ...
        if factor_info == self.answer:
            ...
            lbl_msg = tk.Label(
                self.frame_restrict,
                text="This is a restricted appliation.",
                bg="sienna2",
            )
    ...
    def reset_authorizaiton(self):
        ...
        if student_username == self.username and student_password == self.password:
            ...
            self.btn_reset_auth = tk.Button(
                self.frame_reset,
                text="SET new Username and Password",
                command=self.set_authorization_UI,
            )
    ...
    def get_authorization(self):
        s1 = [None] * (self.username.__len__() + self.password.__len__() + 1)
        a = self.username
        b = self.password
