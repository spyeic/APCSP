...
# choose countries of interest in america
my_countries = [
    "Canada",
    "United States",
    "Mexico",
...
df = pd.read_csv(
    "elec_access_data.csv", header=0
)  # header=0 means there is a header in row 0
...
plt.xlabel("Year")
plt.title("Percent of Population with Access to Electricity in Aferica")
plt.legend()
plt.show()
